...
function main(){
    const qtd_de_testes = obter_numero_em_led_valido(`Digite a quantidade de casos testes desejada:`)

    for(let i = 0; i < qtd_de_testes; i++){
        const numero_em_led = obter_numero_em_led_valido('Digite o número que deseja obter em led:')
        const numero_em_led_em_string = numero_em_led
