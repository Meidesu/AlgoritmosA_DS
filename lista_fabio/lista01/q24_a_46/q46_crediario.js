...
const valorMercadoria = Number(question("Digite o valor da mercadoria: "));

const entrada = Math.ceil(valorMercadoria / 3);
const prestacao = Math.floor(valorMercadoria / 3);

console.log(`Entrada: R$ ${entrada.toFixed(2)}`);
console.log(`Prestações: 2x R$ ${prestacao.toFixed(2)}`);
